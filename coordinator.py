...
class AIDojo:
    ...
    # async def main_coordinator(self, ALLOWED_ROLES=['Attacker', 'Defender', 'Human']):
        """
        ...
        try:
            ...
            while True:
                ...
                agent_addr, message = await self._action_queue.get()
                if message is not None:
                    ...
                    try:
                        ...
                        raise e
                    # Send to anwer_queue
                    await self._answer_queue.put(output_message)
