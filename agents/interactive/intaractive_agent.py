...
class InteractiveAgent:
    ...
    def _get_action_type_from_stdin(self)->ActionType:
        ...
        return self._get_selection_from_user(ActionType, "Select an action to play: ")
    ...
    def _get_action_params_from_stdin(self, action_type:ActionType, current:GameState)->dict:
        if action_type == ActionType.ScanNetwork:
            ...
            if trg_host in current.known_services:
                ...
                service = self._get_selection_from_user(current.known_services[trg_host], f"Select service to exploint: ")
            ...
            if src_host in current.known_data:
                ...
                data = self._get_selection_from_user(current.known_data[src_host], f"Select data to exflitrate: ")
                if data:
