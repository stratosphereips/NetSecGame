...
from env.game_components import Action, ActionType, GameState
...
if __name__ == "__main__":
    ...
    # training arguments
    parser.add_argument(
        "--episodes", help="Sets number of training episodes", default=5000, type=int
    )
    parser.add_argument(
        "--eval_each",
