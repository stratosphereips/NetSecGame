# Game Components
There are several builing blocks of the NetSecGame environment that represent the enities in the world. They are use both in the [Actions](#actions) and [GameState](#gamestate).
...
## GameState
GameState is an object that represents a view of the NetSecGame environment in a given state. It is constructed as a collection of 'assets' known to the agent. GameState has following parts:
