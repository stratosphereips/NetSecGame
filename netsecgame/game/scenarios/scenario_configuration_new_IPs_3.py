...
smb_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.47.2"), cyst_cfg.IPNetwork("10.0.47.0/24"))],
    shell="powershell",
    id="smb_server"
)
...
db_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.47.3"), cyst_cfg.IPNetwork("10.0.47.0/24"))],
    shell="bash",
    id="db_server"
)
...
web_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.47.4"), cyst_cfg.IPNetwork("10.0.47.0/24"))],
    shell="bash",
    id="web_server"
)
...
other_server_1 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.47.5"), cyst_cfg.IPNetwork("10.0.47.0/24"))],
    shell="bash",
    id="other_server_1"
)
...
other_server_2 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.47.6"), cyst_cfg.IPNetwork("10.0.47.0/24"))],
    shell="bash",
    id="other_server_2"
)
...
client_1 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.46.2"), cyst_cfg.IPNetwork("10.0.46.0/24"))],
    shell="powershell",
    id="client_1"
)
...
client_2 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.46.3"), cyst_cfg.IPNetwork("10.0.46.0/24"))],
    shell="powershell",
    id="client_2"
)
...
client_3 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.46.4"), cyst_cfg.IPNetwork("10.0.46.0/24"))],
    shell="bash",
    id="client_3"
)
...
client_4 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.46.5"), cyst_cfg.IPNetwork("10.0.46.0/24"))],
    shell="bash",
    id="client_4"
)
...
client_5 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.46.6"), cyst_cfg.IPNetwork("10.0.46.0/24"))],
    shell="bash",
    id="client_5"
)
...
router1 = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.47.1"), cyst_cfg.IPNetwork("10.0.47.0/24"), index=2),
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.0.46.1"), cyst_cfg.IPNetwork("10.0.46.0/24"), index=3),
    ],
    routing_table=[
        ...
        cyst_cfg.FirewallConfig(
          ...
          chains=[
              cyst_cfg.FirewallChainConfig(
                ...
                rules=[
                    cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.47.0/24"), cyst_cfg.IPNetwork("10.0.47.1/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                    cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.0/24"), cyst_cfg.IPNetwork("10.0.46.1/32"), "*", cyst_cfg.FirewallPolicy.ALLOW)
                ]
              ),
              cyst_cfg.FirewallChainConfig(
                  ...
                  rules=[
                      ...
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.2/32"), cyst_cfg.IPNetwork("10.0.47.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.2/32"), cyst_cfg.IPNetwork("10.0.47.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.2/32"), cyst_cfg.IPNetwork("10.0.47.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 2 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.3/32"), cyst_cfg.IPNetwork("10.0.47.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.3/32"), cyst_cfg.IPNetwork("10.0.47.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.3/32"), cyst_cfg.IPNetwork("10.0.47.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 3 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.4/32"), cyst_cfg.IPNetwork("10.0.47.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.4/32"), cyst_cfg.IPNetwork("10.0.47.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.4/32"), cyst_cfg.IPNetwork("10.0.47.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 4 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.5/32"), cyst_cfg.IPNetwork("10.0.47.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.5/32"), cyst_cfg.IPNetwork("10.0.47.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.5/32"), cyst_cfg.IPNetwork("10.0.47.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 5 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.6/32"), cyst_cfg.IPNetwork("10.0.47.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.6/32"), cyst_cfg.IPNetwork("10.0.47.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("10.0.46.6/32"), cyst_cfg.IPNetwork("10.0.47.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW)
                  ]
              )
          ]
        )
...
- Represented as a router outside the scenario network 10.0.0.0/16
'''
internet = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("55.34.2.1"), cyst_cfg.IPNetwork("55.34.2.1/26"), index=0)
    ],
    routing_table=[
        RouteConfig(cyst_cfg.IPNetwork("10.0.0.0/16"), 0)
    ],
    traffic_processors=[],
    id="internet"
)
...
outside_node = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("55.34.2.5"), cyst_cfg.IPNetwork("55.34.2.4/26"))],
    shell="bash",
    id="outside_node"
)
