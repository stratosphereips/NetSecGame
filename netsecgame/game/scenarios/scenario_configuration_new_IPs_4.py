...
smb_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.2.2"), cyst_cfg.IPNetwork("172.19.2.0/24"))],
    shell="powershell",
    id="smb_server"
)
...
db_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.2.3"), cyst_cfg.IPNetwork("172.19.2.0/24"))],
    shell="bash",
    id="db_server"
)
...
web_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.2.4"), cyst_cfg.IPNetwork("172.19.2.0/24"))],
    shell="bash",
    id="web_server"
)
...
other_server_1 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.2.5"), cyst_cfg.IPNetwork("172.19.2.0/24"))],
    shell="bash",
    id="other_server_1"
)
...
other_server_2 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.2.6"), cyst_cfg.IPNetwork("172.19.2.0/24"))],
    shell="bash",
    id="other_server_2"
)
...
client_1 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.1.2"), cyst_cfg.IPNetwork("172.19.1.0/24"))],
    shell="powershell",
    id="client_1"
)
...
client_2 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.1.3"), cyst_cfg.IPNetwork("172.19.1.0/24"))],
    shell="powershell",
    id="client_2"
)
...
client_3 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.1.4"), cyst_cfg.IPNetwork("172.19.1.0/24"))],
    shell="bash",
    id="client_3"
)
...
client_4 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.1.5"), cyst_cfg.IPNetwork("172.19.1.0/24"))],
    shell="bash",
    id="client_4"
)
...
client_5 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.1.6"), cyst_cfg.IPNetwork("172.19.1.0/24"))],
    shell="bash",
    id="client_5"
)
...
router1 = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.2.1"), cyst_cfg.IPNetwork("172.19.2.0/24"), index=2),
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("172.19.1.1"), cyst_cfg.IPNetwork("172.19.1.0/24"), index=3),
    ],
    routing_table=[
        ...
        cyst_cfg.FirewallConfig(
          ...
          chains=[
              cyst_cfg.FirewallChainConfig(
                ...
                rules=[
                    cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.2.0/24"), cyst_cfg.IPNetwork("172.19.2.1/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                    cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.0/24"), cyst_cfg.IPNetwork("172.19.1.1/32"), "*", cyst_cfg.FirewallPolicy.ALLOW)
                ]
              ),
              cyst_cfg.FirewallChainConfig(
                  ...
                  rules=[
                      ...
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.2/32"), cyst_cfg.IPNetwork("172.19.2.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.2/32"), cyst_cfg.IPNetwork("172.19.2.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.2/32"), cyst_cfg.IPNetwork("172.19.2.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 2 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.3/32"), cyst_cfg.IPNetwork("172.19.2.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.3/32"), cyst_cfg.IPNetwork("172.19.2.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.3/32"), cyst_cfg.IPNetwork("172.19.2.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 3 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.4/32"), cyst_cfg.IPNetwork("172.19.2.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.4/32"), cyst_cfg.IPNetwork("172.19.2.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.4/32"), cyst_cfg.IPNetwork("172.19.2.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 4 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.5/32"), cyst_cfg.IPNetwork("172.19.2.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.5/32"), cyst_cfg.IPNetwork("172.19.2.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.5/32"), cyst_cfg.IPNetwork("172.19.2.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      # Client 5 can go to server 1, 2, 3
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.6/32"), cyst_cfg.IPNetwork("172.19.2.2/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.6/32"), cyst_cfg.IPNetwork("172.19.2.3/32"), "*", cyst_cfg.FirewallPolicy.ALLOW),
                      cyst_cfg.FirewallRule(cyst_cfg.IPNetwork("172.19.1.6/32"), cyst_cfg.IPNetwork("172.19.2.4/32"), "*", cyst_cfg.FirewallPolicy.ALLOW)
                  ]
              )
          ]
        )
...
- Represented as a router outside the scenario network 10.7.0.0/16
'''
internet = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("101.32.5.3"), cyst_cfg.IPNetwork("101.32.5.0/26"), index=0)
    ],
    routing_table=[
        RouteConfig(cyst_cfg.IPNetwork("172.19.0.0/16"), 0)
    ],
    traffic_processors=[],
    id="internet"
)
...
outside_node = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("101.32.5.23"), cyst_cfg.IPNetwork("101.32.5.0/26"))],
    shell="bash",
    id="outside_node"
)
