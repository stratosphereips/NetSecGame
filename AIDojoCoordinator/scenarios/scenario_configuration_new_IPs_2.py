...
internet = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("54.123.53.28"), cyst_cfg.IPNetwork("32.8.23.0/26"), index=0)
    ],
    routing_table=[
...
outside_node = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("32.8.23.1"), cyst_cfg.IPNetwork("32.8.23.0/26"))],
    shell="bash",
    id="outside_node"
)
