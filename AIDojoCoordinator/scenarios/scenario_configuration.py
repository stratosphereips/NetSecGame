...
db_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("192.168.1.3"), cyst_cfg.IPNetwork("192.168.1.0/24"))],
    shell="bash",
    id="db_server"
)
...
web_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("192.168.1.4"), cyst_cfg.IPNetwork("192.168.1.0/24"))],
    shell="bash",
    id="web_server"
)
...
other_server_1 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("192.168.1.5"), cyst_cfg.IPNetwork("192.168.1.0/24"))],
    shell="bash",
    id="other_server_1"
)
...
other_server_2 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("192.168.1.6"), cyst_cfg.IPNetwork("192.168.1.0/24"))],
    shell="bash",
    id="other_server_2"
)
...
internet = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("213.47.23.193"), cyst_cfg.IPNetwork("213.47.23.0/26"), index=0)
    ],
    routing_table=[
...
outside_node = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("213.47.23.195"), cyst_cfg.IPNetwork("213.47.23.0/26"))],
    shell="bash",
    id="outside_node"
)
