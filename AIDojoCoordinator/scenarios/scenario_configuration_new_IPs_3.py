...
internet = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("55.34.2.1"), cyst_cfg.IPNetwork("55.34.2.0/26"), index=0)
    ],
    routing_table=[
...
outside_node = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("55.34.2.5"), cyst_cfg.IPNetwork("55.34.2.0/26"))],
    shell="bash",
    id="outside_node"
)
