...
smb_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.7.45.2"), cyst_cfg.IPNetwork("10.7.45.0/24"))],
    shell="powershell",
    id="smb_server"
)
...
db_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.7.45.3"), cyst_cfg.IPNetwork("10.7.45.0/24"))],
    shell="bash",
    id="db_server"
)
...
web_server = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.7.45.4"), cyst_cfg.IPNetwork("10.7.45.0/24"))],
    shell="bash",
    id="web_server"
)
...
other_server_1 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.7.45.5"), cyst_cfg.IPNetwork("10.7.45.0/24"))],
    shell="bash",
    id="other_server_1"
)
...
other_server_2 = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("10.7.45.6"), cyst_cfg.IPNetwork("10.7.45.0/24"))],
    shell="bash",
    id="other_server_2"
)
...
internet = cyst_cfg.RouterConfig(
    interfaces=[
        cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("54.123.53.28"), cyst_cfg.IPNetwork("54.123.53.0/26"), index=0)
    ],
    routing_table=[
        RouteConfig(cyst_cfg.IPNetwork("10.7.0.0/16"), 0)
    ],
    traffic_processors=[],
    id="internet"
)
...
outside_node = cyst_cfg.NodeConfig(
    ...
    traffic_processors=[],
    interfaces=[cyst_cfg.InterfaceConfig(cyst_cfg.IPAddress("54.123.53.21"), cyst_cfg.IPNetwork("54.123.53.0/26"))],
    shell="bash",
    id="outside_node"
)
